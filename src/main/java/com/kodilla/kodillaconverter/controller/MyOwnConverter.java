...
public class MyOwnConverter implements HttpMessageConverter<Object> {

    @Override
    public boolean canRead(Class<?> clazz, MediaType mediaType) {

        return clazz.getName().equals("com.kodilla.kodillaconverter.domain.MyOwnConverterClass") &&
    ...
    public Object read(Class<?> clazz, HttpInputMessage inputMessage) throws IOException {
        ...
        return new MyOwnConverterClass(fields[0], fields[1]);
